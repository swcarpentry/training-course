...
[<img src="/training-course/uploads/2013/08/Python-with-stmt-concept-map.jpg" alt="Python-with-stmt-concept-map" class="alignnone size-medium wp-image-3767" />][1]
...
2.  You are downloading data from a repository. When you open a link to the repository, it returns a `BigData` object. The result of `dir(BigData)` is: 
 ...
 [1]: /training-course/uploads/2013/08/Python-with-stmt-concept-map.jpg
